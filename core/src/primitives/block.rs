use crate::imports::*;
use bunkernet_rpc_core::RpcBlock;
...
impl DagBlock {
    ...
    pub fn direct_parents(&self) -> &[BunkernetHash] {
...
impl DaaBucket {
    ...
    pub fn update_vspc(&mut self, hash: BunkernetHash, flag: bool, settings: &BlockDagGraphSettings) {
