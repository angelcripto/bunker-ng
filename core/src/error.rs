...
pub enum Error {
    ...
    #[error(transparent)]
    WalletError(#[from] bunkernet_wallet_core::error::Error),
    ...
    #[error(transparent)]
    WrpcClientError(#[from] bunkernet_wrpc_client::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] bunkernet_bip32::Error),

    #[error("Missing external bunkerd node binary")]
    MissingExternalBunkerdBinary,

    #[error("Invalid URL: {0}")]
    InvalidUrl(String),

    #[error(transparent)]
    RpcError(#[from] bunkernet_rpc_core::error::RpcError),
    ...
    #[error("Metrics: {0}")]
    Metrics(#[from] bunkernet_metrics_core::error::Error),
    ...
    #[error(transparent)]
    AddressError(#[from] bunkernet_addresses::AddressError),
    ...
    #[error(transparent)]
    NetworkType(#[from] bunkernet_consensus_core::network::NetworkTypeError),
