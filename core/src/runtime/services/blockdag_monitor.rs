use crate::imports::*;
use bunkernet_notify::{listener::ListenerId, scope::*};
use bunkernet_rpc_core::api::notifications::Notification;
use bunkernet_rpc_core::notify::connection::{ChannelConnection, ChannelType};
use bunkernet_rpc_core::{RpcBlock, VirtualChainChangedNotification};
...
pub struct BlockDagMonitorService {
    ...
    pub new_blocks: Arc<Mutex<AHashSet<bunkernet_consensus_core::Hash>>>,
...
impl BlockDagMonitorService {
    ...
    pub fn new_blocks(&self) -> MutexGuard<'_, AHashSet<bunkernet_consensus_core::Hash>> {
...
impl Service for BlockDagMonitorService {
    ...
    async fn spawn(self: Arc<Self>) -> Result<()> {
        ...
        let mut blocks_by_hash: AHashMap<bunkernet_consensus_core::Hash, Arc<RpcBlock>> =
            AHashMap::default();
