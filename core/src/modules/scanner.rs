...
use bunkernet_wallet_core::{wallet::Wallet, account::{BIP32_ACCOUNT_KIND, LEGACY_ACCOUNT_KIND}};
                ...
                Panel::new(self)
                    ...
                    .with_body(|this, ui|{
                        ...
                        if !core.state().is_open() {
                            ...
                            ui.add_space(8.);
                            ui.label(i18n("The node is currently syncing with the BunkerNet p2p network. Please wait for the node to sync."));
                            ui.add_space(16.);
