...
use crate::imports::*;
use bunkernet_bip32::Mnemonic;
// use bunkernet_wallet_core::runtime::{PrvKeyDataCreateArgs, WalletCreateArgs};
// use bunkernet_wallet_core::storage::AccountKind;
        ...
        ui.with_layout(egui::Layout::top_down(egui::Align::Center), |ui| {
            ...
            match self.state.clone() {
                ...
                State::PresentMnemonic(_creation_data) => {
                    ...
                    //             the BNT stored in it. Keep your mnemonic safe. Write it down and \
